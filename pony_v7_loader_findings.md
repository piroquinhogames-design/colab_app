...
Novo perfil solicitado: Prefect Pony XL V6, Civitai model id 439889, modelVersionId 2114187. A página pública identifica a versão como `prefect_pony_v6.fp16.safetensors`, tipo `CheckpointMerge`, base `Pony`, variante `fp16 SafeTensor`, tamanho aproximado de 6,46 GB, hash AutoV2 `20FECC2EC6`, licença CreativeML Open RAIL++-M e download `https://civitai.red/api/download/models/2114187?fileId=2008663`. O perfil é compatível com o caminho SDXL single-file do projeto; não usa AuraFlow.
